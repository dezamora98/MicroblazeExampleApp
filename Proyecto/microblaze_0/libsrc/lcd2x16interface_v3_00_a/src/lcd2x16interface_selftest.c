/*****************************************************************************
* Filename:          Z:\SysEmp\test_MB_LCDCtr\TestLCD_2/drivers/lcd2x16interface_v3_00_a/src/lcd2x16interface_selftest.c
* Version:           3.00.a
* Description:       Contains a diagnostic self-test function for the lcd2x16interface driver
...
XStatus LCD2X16INTERFACE_SelfTest(void * baseaddr_p)
{
  ...
  LCD2X16INTERFACE_mWriteSlaveReg0(baseaddr, 0, 1);
  Reg32Value = LCD2X16INTERFACE_mReadSlaveReg0(baseaddr, 0);
