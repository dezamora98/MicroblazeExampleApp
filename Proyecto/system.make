...
# \\vboxsvr\workarea\SysEmp\ProyectoFinal\ProyectoFinalSDE\Proyecto\system.mhs
# The software specification of the system is in file :
# \\vboxsvr\workarea\SysEmp\ProyectoFinal\ProyectoFinalSDE\Proyecto\system.mss
...
test_0_program: $(CYG_TEST_0_OUTPUT) 

$(CYG_TEST_0_OUTPUT) : $(TEST_0_SOURCES) $(TEST_0_HEADERS) $(TEST_0_LINKER_SCRIPT) \
                    $(LIBRARIES) __xps/test_0_compiler.opt
	@mkdir -p $(TEST_0_OUTPUT_DIR) 
	$(TEST_0_CC) $(TEST_0_CC_OPT) $(TEST_0_SOURCES) -o $(CYG_TEST_0_OUTPUT) \
	$(TEST_0_OTHER_CC_FLAGS) $(TEST_0_INCLUDES) $(TEST_0_LIBPATH) \
	$(TEST_0_CFLAGS) $(TEST_0_LFLAGS) 
	$(TEST_0_CC_SIZE) $(CYG_TEST_0_OUTPUT) 
	@echo ""
