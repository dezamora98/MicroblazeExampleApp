/*****************************************************************************
* Filename:          Z:\SysEmp\ProyectoFinal\ProyectoFinalSDE\Proyecto/drivers/digilentspartan3espi_v1_00_a/src/digilentspartan3espi_selftest.c
* Version:           1.00.a
* Description:       Contains a diagnostic self-test function for the digilentspartan3espi driver
...
#include "digilentspartan3espi.h"
...
XStatus DIGILENTSPARTAN3ESPI_SelfTest(void * baseaddr_p)
{
  ...
  DIGILENTSPARTAN3ESPI_mWriteSlaveReg0(baseaddr, 0, 1);
  Reg32Value = DIGILENTSPARTAN3ESPI_mReadSlaveReg0(baseaddr, 0);
